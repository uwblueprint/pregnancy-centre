    ...
    return (
        ...
        >
            <div className="delete-request-type-form-content">
                <p>
                    Are you sure you want to delete <b>&#34;{props.requestTypeName ?? "this"}&#34;</b> as a type in the
                    group <b>&#34;{props.requestGroupName ?? ""}&#34;</b>? This will delete all{" "}
                    <b>{props.numRequests}</b> requests within this type and cannot be undone.
                </p>
            </div>
        </FormModal>
    );
