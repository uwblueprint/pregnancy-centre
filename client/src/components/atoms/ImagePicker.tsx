  ...
  return (
    <div className="imagepicker">
          ...
          <div className={isErroneous ? "error" : "unselected"} id="cropField">
            {uploadedImg !== "" ?
             <Cropper 
                ...
                maxZoom={10}
                cropSize={{ height: document.getElementById("cropField")!.offsetHeight, width: document.getElementById("cropField")!.offsetWidth}}
                showGrid={false}
              />
            :
      ...
      <div className={uploadedImg === "" ? "imagepicker-hidden" : "imagepicker-crop-controls"}>
        ...
        <button className={imgInView ? "btn btn-light imagepicker-trash" : "imagepicker-hidden"} onClick={clearImage}><i className="bi bi-trash"></i></button>
      {images.length > 1 && (
        <ImageList
          selected={selected}
          images={images}
