                ...
                body={
                    <div className="send-reset-password-email-modal">
                        <p className="send-reset-password-email-modal-instructions">
                            If your email is registered we’ll send a password reset link to the email address below
                        ...
                        <form onSubmit={handleSubmit}>
                            <div>
                                ...
                                <div className={errors && `row bordered error`}>
                                    <input
                                        name="email"
                                    ...
                                    />
                                    <div className={errors ? "text-field-input-alert" : "hidden"}>
                ...
                body={
                    <span>
                        <div className="text">
                            ...
                            <div className="text">
                                The link will expire after 1 hour, after which you’ll have to request another reset
                                link.
                            </div>
                        </div>
